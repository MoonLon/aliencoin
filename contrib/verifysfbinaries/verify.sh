...
###   This script attempts to download the signature file SHA256SUMS.asc from aliencoin.org
...
WORKINGDIR="/tmp/aliencoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://aliencoin.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://aliencoin.org/bin/"
VERSIONPREFIX="aliencoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'aliencoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[aliencoin-]<version>-[rc[0-9]] (example: aliencoin-0.9.2-rc1)"
   echo "wget output:"
