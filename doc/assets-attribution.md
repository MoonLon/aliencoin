The following is a list of assets used in the aliencoin source and their proper attribution.
...
* License: MIT
* Site: [https://aliencointalk.org/index.php?topic=15276.0](https://aliencointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original aliencoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/aliencoin.icns, src/qt/res/src/aliencoin.svg,
	src/qt/res/src/aliencoin.ico, src/qt/res/src/aliencoin.png,
	src/qt/res/src/aliencoin_testnet.png, docs/aliencoin_logo_doxygen.png,
