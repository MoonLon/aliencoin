...
from test_framework import AliencoinTestFramework
...
class TxnMallTest(AliencoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 ALC:
        ...
        # First: use raw transaction API to send 1210 ALC to node1_address,
        # but don't broadcast:
        ...
        # Node0's balance should be starting balance, plus 50ALC for another
        ...
        # Node0's total balance should be starting balance, plus 100ALC for 
