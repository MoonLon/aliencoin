...
unlocked to sign the Aliencoin-Qt.app bundle.
...
allowing somebody to distribute a Aliencoin-Qt.app or aliencoin-qt-setup.exe with a valid
...
that the aliencoin-qt.exe file inside the installer had not been tampered with.
