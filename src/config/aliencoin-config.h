/* src/config/aliencoin-config.h.  Generated from aliencoin-config.h.in by configure.  */
/* src/config/aliencoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef ALIENCOIN_CONFIG_H

#define ALIENCOIN_CONFIG_H
...
#define PACKAGE_BUGREPORT "info@aliencoin.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Aliencoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Aliencoin Core 0.10.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "aliencoin"
