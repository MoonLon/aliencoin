...
#ifndef ALIENCOIN_QT_ALIENCOINUNITS_H
#define ALIENCOIN_QT_ALIENCOINUNITS_H
...
/** Aliencoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class AliencoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit AliencoinUnits(QObject *parent);

    /** Aliencoin units.
      @note Source: https://en.aliencoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        ALC,
...
typedef AliencoinUnits::Unit AliencoinUnit;

#endif // ALIENCOIN_QT_ALIENCOINUNITS_H
