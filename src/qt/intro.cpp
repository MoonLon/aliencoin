...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/aliencoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Aliencoin Core"),
     ...
     * override -datadir in the aliencoin.conf file in the default data directory
     * (to be consistent with aliencoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
