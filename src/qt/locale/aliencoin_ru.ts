...
<context>
    ...
    <message>
        ...
        <translation>Это ваши адреса Aliencoin для отправки платежей. Всегда проверяйте количество и адрес получателя перед отправкой перевода.</translation>
    </message>
    <message>
        ...
        <translation>Это ваши адреса Aliencoin для приёма платежей. Рекомендуется использовать новый адрес получения для каждой транзакции.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Aliencoin Core клиент</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Показать информацию о Aliencoin Core</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подписать сообщения вашим адресом Aliencoin, чтобы доказать, что вы им владеете</translation>
    </message>
    <message>
        <source>Verify messages to ensure they were signed with specified Aliencoin addresses</source>
        <translation>Проверить сообщения, чтобы удостовериться, что они были подписаны определённым адресом Aliencoin</translation>
    </message>
    <message>
        <source>&amp;File</source>
    ...
    <message>
        ...
        <translation>Запросить платежи (создаёт QR-коды и aliencoin: ссылки)</translation>
    </message>
    <message>
        <source>&amp;About Aliencoin Core</source>
        <translation>&amp;О Aliencoin Core</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Открыть aliencoin: URI или запрос платежа</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Показать помощь по Aliencoin Core и получить список доступных параметров командной строки.</translation>
    </message>
    <message numerus="yes">
        <source>%n active connection(s) to Aliencoin network</source>
        <translation><numerusform>%n активное соединение с сетью</numerusform><numerusform>%n активных соединений с сетью</numerusform><numerusform>%n активных соединений с сетью Aliencoin</numerusform></translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Добро пожаловать в Aliencoin Core.</translation>
    </message>
    <message>
        <source>As this is the first time the program is launched, you can choose where Aliencoin Core will store its data.</source>
        <translation>Так как вы впервые запустили программу, вы можете выбрать, где Aliencoin Core будет хранить данные.</translation>
    </message>
    <message>
        ...
        <translation>Aliencoin Core скачает и сохранит копию цепи блоков. Как минимум, %1ГБ данных будет храниться в этом каталоге, и со временем он будет расти. Бумажник будет также сохранён в этом каталоге.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Подключаться к сети Aliencoin через прокси SOCKS5</translation>
    </message>
    <message>
        <source>&amp;Connect through SOCKS5 proxy (default proxy):</source>
        <translation>&amp;Подключаться к сети Aliencoin через прокси SOCKS5 (прокси по умолчанию):</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Не удаётся запустить aliencoin: обработчик click-to-pay</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Введите адрес Aliencoin (например, %1)</translation>
    </message>
    <message>
        <source>%1 d</source>
...
<context>
    ...
    <message>
        ...
        <translation>Необязательное сообщение для запроса платежа, которое будет показано при открытии запроса. Заметьте: сообщение не будет отправлено вместе с платежом через сеть Aliencoin.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Внимание: неверный адрес Aliencoin</translation>
    </message>
    <message>
        <source>(no label)</source>
        <translation>[нет метки]</translation>
...
<context>
    ...
    <message>
        ...
        <translation>Адрес Aliencoin, на который отправить платёж</translation>
    </message>
    <message>
        <source>Alt+A</source>
    ...
    <message>
        ...
        <translation>К aliencoin: URI было прикреплено сообщение, которое будет сохранено вместе с транзакцией для вашего сведения. Заметьте: сообщение не будет отправлено через сеть Aliencoin.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Aliencoin Core выключается...</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Адрес Aliencoin, которым подписать сообщение</translation>
    </message>
    <message>
        <source>Choose previously used address</source>
        <translation>Выберите ранее использованный адрес</translation>
    ...
    <message>
        ...
        <translation>Адрес Aliencoin, которым было подписано сообщение</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Разработчики Aliencoin Core</translation>
    </message>
    <message>
...
Например: alertnotify=echo %%s | mail -s "Aliencoin Alert" admin@foo.com
</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Не удалось забиндиться на %s на этом компьютере. Возможно, Aliencoin Core уже запущен.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Не удалось установить блокировку на каталог данных %s. Возможно, Aliencoin Core уже запущен.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Комиссии (в ALC/Кб) меньшие этого значения считаются нулевыми для трансляции (по умолчанию: %s)</translation>
    </message>
    <message>
        <source>Fees (in ALC/Kb) smaller than this are considered zero fee for transaction creation (default: %s)</source>
        <translation>Комиссии (в ALC/Кб) меньшие этого значения считаются нулевыми для создания транзакции (по умолчанию: %s)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Внимание: убедитесь, что дата и время на Вашем компьютере выставлены верно. Если Ваши часы идут неправильно, Aliencoin Core будет работать некорректно.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Все права защищены © 2009-%i Разработчики Aliencoin Core</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Ошибка загрузки wallet.dat: бумажник требует более новую версию Aliencoin Core</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Комиссия (в ALC/Кб) для добавления к вашим транзакциям (по умолчанию: %s)</translation>
    </message>
    <message>
        <source>Information</source>
        <translation>Информация</translation>
    ...
    <message>
        ...
        <translation>Не удалось проверить чистоту. Aliencoin Core выключается.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Параметры RPC SSL: (см. Aliencoin вики для инструкций по настройке SSL)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Необходимо перезаписать бумажник, перезапустите Aliencoin Core для завершения операции.</translation>
    </message>
    <message>
        <source>Warning</source>
        <translation>Внимание</translation>
