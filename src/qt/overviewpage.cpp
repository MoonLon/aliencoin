...
class TxViewDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
public:
    TxViewDelegate(): QAbstractItemDelegate(), unit(AliencoinUnits::ALC)
    {
                      ...
                      const QModelIndex &index ) const
    {
        ...
        painter->setPen(foreground);
        QString amountText = AliencoinUnits::formatWithUnit(unit, amount, true, AliencoinUnits::separatorAlways);
        if(!confirmed)
        {
...
{
    ui->setupUi(this);
	QPixmap pixmap = QPixmap (":/images/walletpic");
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelWatchImmature->setText(AliencoinUnits::formatWithUnit(unit, watchImmatureBalance, false, AliencoinUnits::separatorAlways));
