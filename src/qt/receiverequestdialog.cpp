...
#include "config/aliencoin-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatAliencoinURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + AliencoinUnits::formatWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatAliencoinURI(info));
}
