    ...
    transactionView(0)
{
	...
	setStyleSheet(
		...
		"QComboBox QListView{color:rgb(255,255,255); background-color:rgb(29,34,39);}"
		"QTableView{background-color:rgb(66,71,78);}"
		"QHeaderView::section{background-color:rgb(29,34,39); color:rgb(255,255,255);}"
		"QLineEdit{color:rgb(159,161,164);}"
	);
}
...
void TransactionView::changedAmount(const QString &amount)
{
    ...
    if(AliencoinUnits::parse(model->getOptionsModel()->getDisplayUnit(), amount, &amount_parsed))
    {
...
void TransactionView::exportClicked()
{
    ...
    writer.addColumn(AliencoinUnits::getAmountColumnTitle(model->getOptionsModel()->getDisplayUnit()), 0, TransactionTableModel::FormattedAmountRole);
