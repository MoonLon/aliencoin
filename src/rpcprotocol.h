...
#ifndef ALIENCOIN_RPCPROTOCOL_H
#define ALIENCOIN_RPCPROTOCOL_H
...
enum RPCErrorCode
{
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //! Aliencoin is not connected
