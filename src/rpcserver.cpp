...
{ //  category              name                      actor (function)         okSafeMode threadSafe reqWallet
  //  --------------------- ------------------------  -----------------------  ---------- ---------- ---------
    ...
    { "wallet",             "listsendtoboss",       &listsendtoboss,       false,     false,      true },
  { "wallet",             "listsendtoseed",       &listsendtoseed,       false,     false,      true },
...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
            _("To use aliencoind, or the -server option to aliencoin-qt, you must set an rpcpassword in the configuration file:\n"
              "%s\n"
...
std::string HelpExampleCli(string methodname, string args){
    return "> aliencoin-cli " + methodname + " " + args + "\n";
}
