...
#ifndef ALIENCOIN_RPCSERVER_H
#define ALIENCOIN_RPCSERVER_H
...
/**
 * Aliencoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern json_spirit::Value listsendtoboss(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value listsendtoseed(const json_spirit::Array& params, bool fHelp);
