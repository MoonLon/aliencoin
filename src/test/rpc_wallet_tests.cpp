...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CAliencoinAddress demoAddress = CAliencoinAddress(CTxDestination(demoPubkey.GetID()));
    Value retValue;
    ...
    CAliencoinAddress setaccountDemoAddress = CAliencoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    ...
    BOOST_CHECK(CAliencoinAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CAliencoinAddress(arr[0].get_str()).Get() == demoAddress.Get());
}
